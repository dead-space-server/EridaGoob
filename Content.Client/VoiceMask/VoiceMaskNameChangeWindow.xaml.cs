...
public sealed partial class VoiceMaskNameChangeWindow : FancyWindow
{
    ...
    public VoiceMaskNameChangeWindow()
    {
        ...
        // Corvax-TTS-Start
        if (IoCManager.Resolve<IConfigurationManager>().GetCVar(CCVars.TTSEnabled))
        {
    ...
    public void UpdateState(string name, string voice, string? verb, bool active, bool accentHide)
    {
